...
<main id="main">
    ...
    <section id="hero" class="hero">
      ...
      <img src="img/salon.jpg" alt="" data-aos="fade-in">
    ...
    <section id="features" class="features">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Service</h2>
        <p>Perawatan Yang Akan Membuat Anda Menjadi Lebih Cantik dan Percaya Diri</p>
      ...
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item">
          ...
          <div class="col-lg-7 order-1 order-lg-2 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="100">
            <div class="image-stack">
              <img src="img/hair9.jpg" alt="" class="stack-front">
              <img src="img/hair5.jpg" alt="" class="stack-back">
            </div>
          </div>
        </div><!-- Features Item -->
        ...
        <div class="row gy-4 align-items-stretch justify-content-between features-item ">
          <div class="col-lg-6 d-flex align-items-center features-img-bg" data-aos="zoom-out">
            <img src="img/lashlift5.jpg" class="img-fluid" alt="">
          </div>
        ...
        <div class="row gy-4 align-items-center features-item">
          ...
          <div class="col-lg-7 order-1 order-lg-2 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="100">
            <div class="image-stack">
              {{-- <img src="img/spa.jpg" alt="" class="stack-front"> --}}
              <img src="img/spa.jpg" alt="" class="stack-back">
            </div>
          </div>
        </div><!-- Features Item -->
    ...
    {{-- <section id="services" class="services">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>List Harga</h2>
        <p>Dengan Biaya Yang Terjangkau Anda Bisa Mempercantik Diri</p>
      </div><!-- End Section Title -->
    ...
    <section id="portfolio" class="portfolio">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Portfolio</h2>
        <p>Galeri yang menampilkan hasil perawatan rambut dan kecantikan dari Lily Ann Salon.</p>
      </div><!-- End Section Title -->
      ...
      <div class="container">
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
            ...
            <li data-filter=".filter-beauty">Beauty Treatment</li>
            <li data-filter=".filter-spa">Spa/mask</li>
          </ul><!-- End Portfolio Filters -->

          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">

            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-hair">
              <img src="img/hair7.jpg" class="img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-hair">
              <img src="img/hair2.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Hair Treatment</h4>
                <p>Hair Clamp</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-hair">
              <img src="img/hair8.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Hair Treatment</h4>
                <p>Hair Clamp</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-hair">
              <img src="img/hair9.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Hair Treatment</h4>
                <p>Hair Clamp</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-beauty">
              <img src="img/lashlift4.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-beauty">
              <img src="img/lashlift3.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Beauty Treatment</h4>
                <p>Lashlift</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-beauty">
              <img src="img/lashlift1.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Beauty Treatment</h4>
                <p>Lashlift</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-beauty">
              <img src="img/lashlift2.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Beauty Treatment</h4>
                <p>Lashlift</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-spa">
        ...
        <div class="row g-4">
          ...
          <div class="col-lg-4">
            <div class="pricing-item">
              ...
              <ul>
                <li><span>Facial Sari Ayu</span></li>
                <li><span>Facial Viva</span></li>
                <li><span>Message Wajah</span></li>
                <li><span>Lashlift</span></li>
              </ul>
              <div class="text-center"><a href="{{ url('price') }}" class="buy-btn">See Detail</a></div>
            </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="pricing-item"> 
              ...
              <ul>
                <li><span>Potong</span></li>
                <li><span>Potong Cuci Tonic</span></li>
                <li><span>Potong Cuci Blow</span></li>
                <li><span>Cuci Catok</span></li>
                <li><span>Cuci Blow</span></li>
                <li><span>Cuci Curly</span></li>
          ...
          <div class="col-lg-4">
            <div class="pricing-item">
              <h3>Hair Spa/ <br>Mask</h3>
              {{-- <div class="icon">
                <i class="bi bi-send"></i>
              </div>
              <h4><sup>$</sup>49<span> / month</span></h4> --}}
              <ul>
                <li><span>Pendek</span></li>
                <li><span>Medium</span></li>
                <li><span>Panjang</span></li>
                <li><span>Creambath</span></li>
              </ul>
              <div class="text-center"><a href="{{ url('price') }}" class="buy-btn">See Detail</a></div>
            </div>
          </div><!-- End Pricing Item -->
        ...
        <div class="row justify-content-center" data-aos="zoom-in" data-aos-delay="100">
          <div class="col-xl-10">
            <div class="text-center">
              <h3>Social Media</h3>
              <p>Kunjungi Sosial Media Kami di Instagram</p>
              <a class="cta-btn" href="https://www.instagram.com/_lilyansalon/"><i class="bi bi-instagram"></i> Instagram</a>
            </div>
          </div>
        </div>
      </div>
